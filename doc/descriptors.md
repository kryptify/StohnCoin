# Support for Output Descriptors in Stohn Core

Since Stohn Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `soh1...` for mainnet or `tsoh1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
on Stohn's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Stohn Core wallets, a convenience function `combo` is
