...
stohn.conf        | contains configuration settings for stohnd or stohn-qt
stohnd.pid        | stores the process id of stohnd while running
...
debug.log           | contains debug information and general logging generated by stohnd or stohn-qt
