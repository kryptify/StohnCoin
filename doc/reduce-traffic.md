...
By default, Stohn Core allows up to 125 connections to different peers, 8 of
...
limits are tiny. Keep in mind that stohn's trustless model works best if you are
