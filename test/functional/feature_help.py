...
"""Verify that starting stohn with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start stohn with -h for help text")
        ...
        self.log.info("Start stohn with -version for version information")
        ...
        self.log.info("Start stohnd with -fakearg to make sure it does not start")
